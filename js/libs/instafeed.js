...
(function() {
  ...
  Instafeed = (function() {
    ...
    Instafeed.prototype.run = function() {
      var header, script;
// added callback before calling JSON.
...
// added error when JSON return an error.
		this.options.error.call(this);
// end
      }
// added success when JSON return an object.
      if (typeof response == 'object') {
...
// added complete callback when objects are inserted
